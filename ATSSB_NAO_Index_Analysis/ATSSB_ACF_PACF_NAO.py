...
path = "/Users/ruting/Documents/macbook/PcBack/30.ATSSB_Code/Code/ATSSB_NAO_Index_Analysis"
os.chdir(path)
...
plt.plot(naots, color='steelblue')
plt.title('North Atlantic Oscillation (NAO) Index Time Series')
plt.xlabel('Year')
plt.ylabel('NAO Index')
plt.tight_layout()
plt.savefig('NAOIndex.png', dpi = 1200, 
...
plt.ylabel('y')
plt.tight_layout()
plt.savefig('y_ARMA.png', dpi = 1200, 
            bbox_inches ='tight', transparent = True)
plt.show()
plt.close('all')
